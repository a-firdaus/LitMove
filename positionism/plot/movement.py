...
def plot_cage_tuple_label(df_distance, df_type, df_idx_tuple, direc_restructure_destination, max_mapping_radius, litype, activate_diameter_line, activate_relabel_s_i, Li_idxs):
    ...
    if Li_idxs == "all":
        ...
        plt.savefig(f"{direc_restructure_destination}/cage_tuple_label_plot_litype{litype}_{i}.pdf", format='pdf')
        
    plt.show()


def plot_cage_tuple_label_edited(df_distance, df_type, df_idx_tuple, direc_restructure_destination, max_mapping_radius, litype, activate_diameter_line, activate_relabel_s_i, Li_idxs):
    category_labels = {
        '48htype2': '48h type 1',
        '48htype1': '48h type 2',
        '48htype3': '48h type 3',
