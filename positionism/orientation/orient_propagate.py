...
def calculate(df_file, direc_restructure_destination, file_restructure, path_perfect_poscar_24, orientation):
    ...
    if orientation == "True":
        ...
        func_cartesian.File.copy_rename_files(df_file_mask_1, direc_restructure_destination, file_restructure, 
        ...
        orient_perfect_structure.with_library(df_file_mask_1, direc_restructure_destination, file_restructure,
                                                structure_reference, "trf_w_lib", prefix=None)
        orient_perfect_structure.with_linalg(df_file_mask_1, direc_restructure_destination, file_restructure,
                                                structure_reference, "trf_w_linalg", prefix=None)
        orient_perfect_structure.get_structure_with_linalg_combinded_with_library(df_file_mask_1,
