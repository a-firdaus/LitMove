...
def get_sum_weirdos_Li_var_not_complete_x(max_mapping_radius, max_mapping_radius_48htype2, activate_radius, 
    ...
    ref_positions_array_all = np.array(parameter.dx_dz(path_ori_ref_48n24, litype))
    ...
    func_directory.copy_rename_single_file(path_folder_name_iter_type, reference_folder, file_perfect_poscar_48n24, prefix=None)
    ...
    # directory.copy_rename_single_file(direc_restructure_destination, direc_perfect_poscar, file_perfect_poscar_48n24, prefix=None)
    func_directory.copy_rename_single_file(direc_restructure_destination, path_folder_name_iter_type, file_perfect_poscar_48n24, prefix=None)

    # directory.copy_rename_files(file_loc_important_cols, direc_restructure_destination, file_restructure, prefix=None,  savedir = True)
    ...
    coor_structure_init_dict = coordinate_and_el.single_structure(ref_structure_48n24)
    coor_structure_init_dict_expanded = coordinate_and_el.single_structure(Structure.from_file(f"{direc_restructure_destination}{file_perfect_poscar_48n24_wo_cif}_expanded.cif"))

    # CONTCAR.positive_lessthan1(file_loc_important_cols, direc_restructure_destination, poscar_line_nr_start, poscar_line_nr_end, contcar_columns_type2, file_type = "CONTCAR", var_name_in = None, var_name_out = "positive", n_decimal=16)
    coordinate_and_el.structures(file_loc_important_cols, mapping = "False")

    # if activate_radius == 3:
    #     flag_and_map.all_atoms_of_el(file_loc_important_cols, coor_structure_init_dict, "Li", max_mapping_radius)
    ...
    #     flag_and_map.li_48htype2(file_loc_important_cols, coor_structure_init_dict, "Li", max_mapping_radius_48htype2, activate_radius)
    ...
    # flag_and_map.all_atoms_of_el(file_loc_important_cols, coor_structure_init_dict, "P", max_mapping_radius)
    # flag_and_map.all_atoms_of_el(file_loc_important_cols, coor_structure_init_dict, "S", max_mapping_radius)
    # flag_and_map.all_atoms_of_el(file_loc_important_cols, coor_structure_init_dict, "Cl", max_mapping_radius)

    atom_indexing.weirdos_el(file_loc_important_cols, "Li", activate_radius)

    # atom_indexing.correcting_idx_and_order_mapped_el(file_loc_important_cols, el="Li")
    atom_indexing.correcting_idx_and_order_mapped_el(file_loc_important_cols, "Li", activate_radius)
    # # output_CIF.create_combine_structure(file_loc_important_cols, direc_restructure_destination, amount_Li, amount_P, amount_S, var_savefilename = "mapLi")
    
    labelling.get_distance_weirdos_label_el(file_loc_important_cols, coor_structure_init_dict, "Li", litype)
    ...
    if full_calculation == False:
        ...
        output_CIF.create_combine_structure(file_loc_important_cols, direc_restructure_destination, amount_Li, amount_P, amount_S, activate_radius, var_savefilename = "mapLi")
        output_CIF.rewrite_cif_w_correct_Li_idx(file_loc_important_cols, direc_restructure_destination, amount_Li, amount_P, amount_S, amount_Cl, var_savefilename_init = "mapLi", var_savefilename_new = "mapLi_reindexed")
        output_CIF.Edit.format_spacing_cif(file_loc_important_cols, direc_restructure_destination, var_savefilename_init = "mapLi_reindexed", var_savefilename_new = "mapLi_reindexed")
        # # # # Operation.File.delete_files(file_loc_important_cols, direc_restructure_destination, file_name_w_format = "mapLi_reindexed.cif")

        output_CIF.rewrite_cif_w_correct_Li_idx_weirdos_appended(file_loc_important_cols, direc_restructure_destination, amount_Li, amount_P, amount_S, amount_Cl, activate_radius,var_savefilename_init = "mapLi", var_savefilename_new = "mapLi_reindexed_weirdos_appended")
        output_CIF.Edit.format_spacing_cif(file_loc_important_cols, direc_restructure_destination, var_savefilename_init = "mapLi_reindexed_weirdos_appended", var_savefilename_new = "mapLi_reindexed_weirdos_appended")
        ...
        CONTCARorPOSCAR.convert_to_cif_pymatgen(file_loc_important_cols, direc_restructure_destination, file_restructure = "CONTCAR_positive", var_name = "CONTCAR_positive_pymatgen")

        # # # output_CIF.ascending_Li(file_loc_important_cols, direc_restructure_destination, var_filename_init = "mapLi_reindexed_weirdos_appended", var_savefilename_new = "mapLi_reindexed_weirdos_appended_reordered")
        # # # output_CIF.format_spacing_cif(file_loc_important_cols, direc_restructure_destination, var_savefilename_init = "mapLi_reindexed_weirdos_appended_reordered", var_savefilename_new = "mapLi_reindexed_weirdos_appended_reordered")

        atom_indexing.get_idx_coor_limapped_weirdos_dict_litype(file_loc_important_cols, coor_structure_init_dict, activate_radius, litype, el="Li")
        ...
        output_weirdos.create_POSCAR_weirdos(coor_weirdos_Li, direc_restructure_destination, lattice_constant, filename = "POSCAR_weirdos")

        labelling.get_label_mapping(file_loc_important_cols, coor_structure_init_dict, "Li", activate_radius, litype)
...
def get_sum_weirdos_Li_x(ref_positions_array, max_mapping_radius, max_mapping_radius_48htype2, 
    ...
    + max_mapping_radius
    + max_mapping_radius_48htype2
    - dataframe_init: don't have to create new df each time
    + activate_radius
    # - file_perfect_poscar_24
    - file_ori_ref_48n24
    + litype
    ...
    # copy ref.cif inside _results/../.. 
    func_directory.copy_rename_single_file(path_folder_name_iter_type, reference_folder, file_ori_ref_48n24, prefix=None)
    ...
    func_directory.copy_rename_single_file(direc_restructure_destination, direc_perfect_poscar, file_ori_ref_48n24, prefix=None)

    # file_loc_mask_1, dataframe = CONTCAR.positive_lessthan1(file_loc, direc_restructure_destination, file_restructure, path_perfect_poscar_24, col_excel_toten, orientation="False")

    func_directory.copy_rename_files(dataframe, direc_restructure_destination, file_restructure, prefix=None, savedir = True)
    ...
    coor_structure_init_dict = coordinate_and_el.single_structure(ref_structure_48n24)
    CONTCARorPOSCAR.positive_lessthan1(dataframe, direc_restructure_destination, poscar_line_nr_start, poscar_line_nr_end, contcar_columns_type2, file_type = "CONTCAR", var_name_in = None, var_name_out = "positive", n_decimal=16)
    coordinate_and_el.structures(dataframe, mapping = "False")

    if activate_radius == 2:
        flag_and_map.all_atoms_of_el(dataframe, coor_structure_init_dict, "Li", max_mapping_radius)
        flag_and_map.li_48htype2(dataframe, coor_structure_init_dict, "Li", max_mapping_radius_48htype2, activate_radius)
        flag_and_map.li_48htypesmerged(dataframe, "Li", activate_radius)
    elif activate_radius == 1:
        flag_and_map.all_atoms_of_el(dataframe, coor_structure_init_dict, "Li", max_mapping_radius)

    # flag_and_map.all_atoms_of_el(dataframe, coor_structure_init_dict, "P", max_mapping_radius)
    # flag_and_map.all_atoms_of_el(dataframe, coor_structure_init_dict, "S", max_mapping_radius)
    # flag_and_map.all_atoms_of_el(dataframe, coor_structure_init_dict, "Cl", max_mapping_radius)
...
def get_sum_weirdos_Li_var_litype(ref_positions_array, max_mapping_radius, max_mapping_radius_48htype2, 
    ...
    file_loc_mask_1, file_loc_important_cols = CONTCARorPOSCAR.positive_lessthan1(file_loc, direc_restructure_destination, file_restructure, path_perfect_poscar_24, col_excel_toten, orientation="False")

    func_directory.copy_rename_files(file_loc_important_cols, direc_restructure_destination, file_restructure, prefix=None, savedir = True)
    ...
    coor_structure_init_dict = coordinate_and_el.single_structure(ref_structure_48n24)
    CONTCARorPOSCAR.positive_lessthan1(file_loc_important_cols, direc_restructure_destination, poscar_line_nr_start, poscar_line_nr_end, contcar_columns_type2, file_type = "CONTCAR", var_name_in = None, var_name_out = "positive", n_decimal=16)
    coordinate_and_el.structures(file_loc_important_cols, mapping = "False")
...
def mapping_process(dataframe, path_perfect_poscar_48n24, direc_restructure_destination, 
                    poscar_line_nr_start, poscar_line_nr_end, contcar_columns_type2, 
                    lattice_constant, amount_Li, amount_P, amount_S, amount_Cl, 
                    full_calculation, activate_radius, max_mapping_radius,
                    max_mapping_radius_48htype2, litype, file_perfect_poscar_48n24_wo_cif):
    ...
    if full_calculation == False:
        ...
        output_CIF.create_combine_structure(dataframe, direc_restructure_destination, amount_Li, amount_P, amount_S, activate_radius, var_savefilename = "mapLi")
        output_CIF.rewrite_cif_w_correct_Li_idx(dataframe, direc_restructure_destination, amount_Li, amount_P, amount_S, amount_Cl, var_savefilename_init = "mapLi", var_savefilename_new = "mapLi_reindexed")
        output_CIF.Edit.format_spacing_cif(dataframe, direc_restructure_destination, var_savefilename_init = "mapLi_reindexed", var_savefilename_new = "mapLi_reindexed")
        # # # # Operation.File.delete_files(dataframe, direc_restructure_destination, file_name_w_format = "mapLi_reindexed.cif")

        output_CIF.rewrite_cif_w_correct_Li_idx_weirdos_appended(dataframe, direc_restructure_destination, amount_Li, amount_P, amount_S, amount_Cl, activate_radius,var_savefilename_init = "mapLi", var_savefilename_new = "mapLi_reindexed_weirdos_appended")
        output_CIF.Edit.format_spacing_cif(dataframe, direc_restructure_destination, var_savefilename_init = "mapLi_reindexed_weirdos_appended", var_savefilename_new = "mapLi_reindexed_weirdos_appended")
        # # # Operation.File.delete_files(dataframe, direc_restructure_destination, file_name_w_format = "mapLi_reindexed_weirdos_appended.cif")

        CONTCARorPOSCAR.convert_to_cif_pymatgen(dataframe, direc_restructure_destination, file_restructure = "CONTCAR_positive", var_name = "CONTCAR_positive_pymatgen")

        # # # output_CIF.ascending_Li(dataframe, direc_restructure_destination, var_filename_init = "mapLi_reindexed_weirdos_appended", var_savefilename_new = "mapLi_reindexed_weirdos_appended_reordered")
        # # # output_CIF.format_spacing_cif(dataframe, direc_restructure_destination, var_savefilename_init = "mapLi_reindexed_weirdos_appended_reordered", var_savefilename_new = "mapLi_reindexed_weirdos_appended_reordered")

        atom_indexing.get_idx_coor_limapped_weirdos_dict_litype(dataframe, coor_structure_init_dict, activate_radius, litype, el="Li")

        CONTCARorPOSCAR.get_latticeconstant_dict(dataframe, direc_restructure_destination, var_filename = "CONTCAR")
        # Plot.StructureAnalysis.energy_vs_latticeconstant(dataframe, var_filename = "CONTCAR")
        structure_analysis.weirdos_directcoor(dataframe, activate_radius)

        coor_weirdos_Li = output_weirdos.get_coor_weirdos_array(dataframe, activate_radius)
        output_weirdos.create_POSCAR_weirdos(coor_weirdos_Li, direc_restructure_destination, lattice_constant, filename = "POSCAR_weirdos")

        labelling.get_label_mapping(dataframe, coor_structure_init_dict, "Li", activate_radius, litype)


def get_sum_weirdos_Li(ref_positions_array, max_mapping_radius, max_mapping_radius_48htype2, 
                       dataframe_init, activate_radius, file_ori_ref_48n24_wo_cif, litype, iter_type, 
                       foldermapping_namestyle_all, modif_all_litype, cif_namestyle_all, full_calculation):
    # renamed from get_sum_weirdos_Li_var_wo_weirdo_litype
    # used in optimizer position
    # used in optimizer radius
    """
    ...
    foldermapping_namestyle_all: True, False, else
    ...
    folder_name_iter_type = f"/{results_folder}/_{iter_type}/{file_ori_ref_48n24_wo_cif}/"
    direc_perfect_poscar = direc+str(folder_name_iter_type)
    func_directory.check_folder_existance(direc_perfect_poscar, empty_folder=False)

    # copy ref.cif inside _results/../.. 
    func_directory.copy_rename_single_file(direc_perfect_poscar, reference_folder, file_ori_ref_48n24, prefix=None)
    ...
    if iter_type == "varying_radius":
        ref_positions_array_all = np.array(parameter.x_y_z(file_path_ori_ref_48n24, litype))
        ...
        # # copy ref.cif inside _results/../.. 
        # func_directory.copy_rename_single_file(path_folder_name_iter_type, reference_folder, file_ori_ref_48n24, prefix=None)
        # func_directory.copy_rename_single_file(path_folder_name_iter_type, reference_folder, file_ori_ref_48n24_wo_cif, prefix=None)

        func_directory.copy_rename_files(dataframe, direc_restructure_destination, file_restructure, prefix=None, savedir = False)
        ...
        path_perfect_poscar_48n24 = opti_position.modif_dx_dz_get_filepath(direc_perfect_poscar, file_path_ori_ref_48n24, ref_positions_array, ref_positions_array_filename, litype, iter_type, modif_all_litype)

        mapping_process(dataframe, path_perfect_poscar_48n24, direc_restructure_destination, 
                            poscar_line_nr_start, poscar_line_nr_end, contcar_columns_type2, 
                            lattice_constant, amount_Li, amount_P, amount_S, amount_Cl, 
                            full_calculation, activate_radius, max_mapping_radius,
                            max_mapping_radius_48htype2, litype, file_ori_ref_48n24_wo_cif)
        ...
        if activate_radius == 1:
            dataframe.to_pickle(f'{direc_perfect_poscar}dataframe_{max_mapping_radius}_{file_ori_ref_48n24_wo_cif}.pkl') 
        elif activate_radius == 2:
            dataframe.to_pickle(f'{direc_perfect_poscar}dataframe_{max_mapping_radius}_{max_mapping_radius_48htype2}_{file_ori_ref_48n24_wo_cif}.pkl')
        # elif activate_radius == 3:
        #     dataframe.to_pickle(f'{path_folder_name_iter_type}dataframe_{max_mapping_radius}_{max_mapping_radius_48htype2}_{max_mapping_radius_48htype1_48htype2}_{file_perfect_poscar_48n24_wo_cif}.pkl')


    elif iter_type == "varying_position":
        # formatted_positions = [Operation.Float.format_float(pos) for pos in ref_positions_array]
        formatted_positions = [pos for pos in ref_positions_array]
        new_dx1_type, new_dx2_type, new_dz_type = formatted_positions
        ...
        if activate_radius == 2:
            folder_name_destination_restructure = f"{direc_perfect_poscar}restructure_{new_dx1_type}_{new_dx2_type}_{max_mapping_radius}_{max_mapping_radius_48htype2}_optimizer/"
        elif activate_radius == 1:
            folder_name_destination_restructure = f"{direc_perfect_poscar}restructure_{new_dx1_type}_{new_dx2_type}_{max_mapping_radius}_optimizer/"
